...
- Collision Detection
	- The game will detect when the player collides with a hazard using collision logic to trigger a game over state.
- Score System
	- The player’s score will increase over time based on survival duration and will be displayed on screen.
...
## Outcomes
Ideal Outcome:
- A polished survival game with smooth gameplay, clean UI, balanced mechanics, and additional visual polish such as improved graphics or simple effects.

Minimal Viable Outcome:
- A working survival game where the player can move, avoid falling hazards, track a score, and restart after a game over.

## Milestones

- Week 1
  1. Implement player movement and basic hazard spawning
  2. Add collision detection and game over condition

- Week 2
  1. Add score system and increasing difficulty
  2. Implement slow-motion ability and cooldown system
